 ...
 */
class Job extends \Project\LineOfWorkBundle\Entity\Job implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'id', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'type', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'company', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'logo', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'url', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'position', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'location', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'description', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'how_to_apply', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'token', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'is_public', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'is_activated', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'email', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'expires_at', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'created_at', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'updated_at', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'user', 'category', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'file', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'temp', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Job' . "\0" . 'choice');
        }
