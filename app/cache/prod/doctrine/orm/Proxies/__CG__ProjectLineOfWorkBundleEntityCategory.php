 ...
 */
class Category extends \Project\LineOfWorkBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Category' . "\0" . 'name', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Category' . "\0" . 'slug', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Category' . "\0" . 'jobs', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Category' . "\0" . 'active_jobs', '' . "\0" . 'Project\\LineOfWorkBundle\\Entity\\Category' . "\0" . 'more_jobs');
        }
