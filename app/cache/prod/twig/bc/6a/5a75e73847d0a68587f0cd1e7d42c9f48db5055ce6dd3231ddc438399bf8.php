...
<div class=\"row\">
    <form action='";
        ...
        ";
        // line 6
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "position", array()), 'widget', array("attr" => array("placeholder" => "position/location/category...", "value" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "query"), "method"), "list" => "search_data_list")));
        echo "
        ...
        echo "
                ...
                <div  class=\"col-lg-6\">
                    ";
        // line 24
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "location", array()), 'widget', array("attr" => array("placeholder" => "location...")));
        echo "
                </div>
            </div> 
        </div>      
