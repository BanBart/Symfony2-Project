    ...
    <div class=\"col-lg-8 col-lg-offset-2\">
        <div class=\"row\">
            <div class=\"col-lg-12\">
                ";
        // line 10
        echo twig_include($this->env, $context, "ProjectLineOfWorkBundle:Job:list.html.twig", array("jobs" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "activejobs", array())));
        echo "
            </div>
        ...
        if (((isset($context["current_page"]) ? $context["current_page"] : null) > 1)) {
            echo "           
                        <li><a href=\"";
            // line 15
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("project_line_of_work_category_show", array("slug" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "slug", array()), "page" => (isset($context["previous_page"]) ? $context["previous_page"] : null))), "html", null, true);
            echo "\">Prevous page</a></li>
                    ";
        }
        // line 17
        echo "                    ";
        if (((isset($context["total_jobs"]) ? $context["total_jobs"] : null) > (isset($context["jobs_per_page"]) ? $context["jobs_per_page"] : null))) {
            // line 18
            echo "                        <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("project_line_of_work_category_show", array("slug" => $this->getAttribute((isset($context["category"]) ? $context["category"] : null), "slug", array()), "page" => (isset($context["next_page"]) ? $context["next_page"] : null))), "html", null, true);
            echo "\">Next page</a></li>
                    ";
        }
        // line 20
