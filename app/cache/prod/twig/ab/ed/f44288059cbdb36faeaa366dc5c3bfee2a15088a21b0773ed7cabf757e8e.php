...
class __TwigTemplate_abedf44288059cbdb36faeaa366dc5c3bfee2a15088a21b0773ed7cabf757e8e extends Twig_Template
{
    ...
    ";
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "7f8d658_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_7f8d658_0") : $this->env->getExtension('assets')->getAssetUrl("css/7f8d658_part_1_custom_1.css");
            // line 9
    ...
    ";
            // asset "7f8d658_1"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_7f8d658_1") : $this->env->getExtension('assets')->getAssetUrl("css/7f8d658_part_1_jquery_2.css");
            echo "        <link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"/>
    ";
            // asset "7f8d658_2"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_7f8d658_2") : $this->env->getExtension('assets')->getAssetUrl("css/7f8d658_part_1_sticky_footer_3.css");
            echo "        <link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"/>
    ";
            ...
            // asset "7f8d658"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_7f8d658") : $this->env->getExtension('assets')->getAssetUrl("css/7f8d658.css");
            echo "        <link rel=\"stylesheet\" type=\"text/css\" media=\"screen\" href=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\"/>
    ";
    ...
    public function block_header($context, array $blocks = array())
    {
        ...
        // line 53
        echo "                    <li class=\"";
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "project_line_of_work_contact")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "\">Contact</a></li>
                    <li class=\"";
        // line 54
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "project_line_of_work_about")) {
            echo "active";
        }
        echo "\"><a href=\"";
        ...
        echo "
            ...
            <div id=\"lng\" class=\"col-lg-2 top-list\">
                <ul class=\"nav navbar-nav pull-right\">
                        <li class='";
        // line 64
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_locale"), "method") == "pl")) {
            echo " active ";
        }
        echo "'>
                            <a href=\"";
        // line 65
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("project_line_of_work_language", array("language" => "pl", "route" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method"))), "html", null, true);
        echo "\">PL</a>
                        </li>
                        <li class=\"";
        // line 67
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_locale"), "method") == "en")) {
            echo " active ";
        }
        echo "\">
                            <a href=\"";
        // line 68
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("project_line_of_work_language", array("language" => "en", "route" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method"))), "html", null, true);
        echo "\">ENG</a>
                        </li>
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "e1ed931_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_e1ed931_0") : $this->env->getExtension('assets')->getAssetUrl("images/e1ed931_logo-lineofwork_1.png");
            // line 79
            echo "                            <img src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            ...
            // asset "e1ed931"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_e1ed931") : $this->env->getExtension('assets')->getAssetUrl("images/e1ed931.png");
            echo "                            <img src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\" alt=\"Example\" width='388' />
                        ";
        ...
        echo "                       
            ...
            <div id='menu' class=\"col-lg-12 medium-list\">
                ...
                <ul class=\"nav navbar-nav\">
                    ...
                    <li class='";
        // line 109
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "project_line_of_work_homepage")) {
            echo "active";
        }
        echo "'>
                        <a href='";
        ...
        // line 113
        echo "                    <li class='";
        if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "project_line_of_work_job")) {
            echo "active";
        }
        echo "'>
                        <a href='";
        ...
        if ($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array())) {
            // line 123
            echo "                        <li class='";
            if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "get", array(0 => "_route"), "method") == "project_line_of_work_user_profile")) {
                echo "active";
            }
            echo "'>
                            <a href=\"";
...
";
    ...
    public function block_footer($context, array $blocks = array())
    {
        ...
        if (isset($context['assetic']['debug']) && $context['assetic']['debug']) {
            // asset "1ff58af_0"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_1ff58af_0") : $this->env->getExtension('assets')->getAssetUrl("images/1ff58af_logo-small-lineofwork_1.png");
            // line 215
            echo "                                    <img src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\" alt=\"Example\" />
            ...
            // asset "1ff58af"
            $context["asset_url"] = isset($context['assetic']['use_controller']) && $context['assetic']['use_controller'] ? $this->env->getExtension('routing')->getPath("_assetic_1ff58af") : $this->env->getExtension('assets')->getAssetUrl("images/1ff58af.png");
            echo "                                    <img src=\"";
            echo twig_escape_filter($this->env, (isset($context["asset_url"]) ? $context["asset_url"] : null), "html", null, true);
            echo "\" alt=\"Example\" />
                                ";
